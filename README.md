...
- 🏢 Currently working as a **Frontend Developer** at **MxAlgo Technologies**  
- 🧩 Building **dashboards** and **IoT frontends** with reusable **React components**  
- ⚡ Experienced in **JavaScript**, **React.js**, and **UI component design**  
- 🧠 Exploring **Python** and **Flask** for backend integration  
- 🌱 Goal: Become a **Full Stack Developer** (React + Python / Node.js)  
